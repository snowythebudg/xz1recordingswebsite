...
import { Text, Box, Icon, LinkBox, Button, Link, Strong, Section } from "@quarkly/widgets";
...
const overrides = {
	...
	"text6": {
		...
		"props": {
			...
			"color": "--purple",
			"md-margin": "0px 0px 20px 0px",
			"children": "Hours of Operation/Extras"
		}
	},
	"text7": {
		"kind": "Text",
		"props": {
			...
			"children": <>
				...
				<Link color="--purple" href="https://drive.google.com/file/d/1XsOuqDjk_5esvAXQ7FgydALj-xDF9t39/view">
					<Strong
...
Object.assign(Footer0308, { ...Section,
	defaultProps,
	overrides
});
export default Footer0308;